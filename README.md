...
- Only new files will be reviewed for this test, please do not edit any existing theme files
...
- All code/components should be built from scratch, this is one of the few times we don't want you to use components already built into the theme :)

Aside from these requirements the test is open to interpretation, feel free to get creative.

Using the [Shopify CLI](https://shopify.dev/docs/storefronts/themes/tools/cli) for development may be helpful.
...
When you've completed the test please email us with a preview link to view your work and include a list of file names you've added to the theme for us to review.

If you have any questions please feel free to reach out to Derek Morash (Lead dev) derek@fieracosmetics.com.

Thank you for taking the time to help us get to know you better!
